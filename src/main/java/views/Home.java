...
public class Home extends JPanel{
	...
	public Home(){
		...
		JLabel descript=new JLabel("Bienvenu sur Youtube Copycat, une application Java qui permet de visionner des videos depuis YouTube et depuis votre ordinateur ! ");
